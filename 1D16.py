...
try:
    ...
    while True:
        ...
        # Safety: if invalid reading, stop and try again.
        ...
        # --- SIGN FIX ---
        # Positive error means "too far" -> go forward
        # Negative error means "too close" -> go backward
        error = dist_to_wall - setpoint

        # Simple proportional controller
        control_signal = Kp * error

        # Convert control signal to robot speeds (clamp to limits)
